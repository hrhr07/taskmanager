  ...
  const TableHeader = () => (
    <thead className="border-b border-gray-300 ">
      <tr className="text-black text-left">
        <th className="py-2">Título de Tarea</th>
        <th className="py-2">Prioridad</th>
        <th className="py-2">Equipo</th>
        <th className="py-2 hidden md:block">Creado en</th>
      </tr>
    </thead>
  );
  ...
  const TableHeader = () => (
    <thead className="border-b border-gray-300 ">
      <tr className="text-black  text-left">
        ...
        <th className="py-2">Creado en</th>
      </tr>
    </thead>
  );
    ...
    return (
      <div className="w-full h-32 bg-white p-5 shadow-md rounded-md flex items-center justify-between">
        <div className="h-full flex flex-1 flex-col justify-between">
          ...
          <span className="text-sm text-gray-400">{"110 el mes pasado"}</span>
        </div>
